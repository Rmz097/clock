...
async function requestWakeLock() {
  ...
  try {
    ...
    console.log(
      "✅ Bloqueo de activación de pantalla obtenido. La pantalla permanecerá encendida para el dashboard.",
    );
    ...
    wakeLock.addEventListener("release", () => {
      console.log(
        "❌ Bloqueo de activación liberado automáticamente por el sistema.",
      );
      wakeLock = null;
    });
  } catch (err) {
    ...
    console.error(
      `🛑 Error al solicitar el Bloqueo de Activación: ${err.message}`,
    );
    wakeLock = null;
  }
}
